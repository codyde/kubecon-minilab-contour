---
description: >-
    Contour is an Ingress controller for Kubernetes that uses Envoy as a proxy, while also introducing a new ingress API (HTTPProxy) which is implemented via a Custom Resource Definition (CRD), expanding Kubernetes out of the box functionality. 
---
